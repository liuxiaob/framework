...
- (void)setupScrollView
{
    ...
    scrollView.backgroundColor = BoBoColor(246, 246, 246);
...
- (void)setupPageControl
{
    ...
    // 2.设置圆点的颜色
    pageControl.currentPageIndicatorTintColor = BoBoColor(253, 98, 42); // 当前页的小圆点颜色
    pageControl.pageIndicatorTintColor = BoBoColor(189, 189, 189); // 非当前页的小圆点颜色
